...
const Drawer = ({
  ...
  <DrawerDirectionContext.Provider value={(direction as Direction) ?? "bottom"}>
...
const directionClasses: Record<Direction, string> = {
  bottom: "inset-x-0 bottom-0 mt-24 rounded-t-[10px] border",
  top: "inset-x-0 top-0 mb-24 rounded-b-[10px] border",
  ...
  return (
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ref={ref}
        className={cn(
          "fixed z-[70] flex h-auto flex-col bg-background",
